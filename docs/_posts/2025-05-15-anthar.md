---
layout: post
title:  "[Draft] Anthar Study: Elevating AI Coding Agents Beyond Benchmarks to Developer-Centric Intelligence"
date:   2025-05-15 01:48:02 +0530
update: 2025-05-21 18:48:02 +0530
categories: deccan agents llms
---

_"The future of software development is not replacing developers, but empowering them with intelligent collaborators."_

AI coding assistants have rapidly evolved from simple autocomplete tools to autonomous agents capable of understanding complex software engineering tasks. However, evaluating these agents remains challenging. Existing benchmarks like SWE-Bench Verified and SWE-PolyBench offer valuable insights but also leave critical gaps—particularly around human-centered value, security awareness, and realistic usage modes.

Amid this landscape, we recognized the urgent need for a more nuanced, human-validated study that captures not only the correctness of AI-generated code but also how these agents perform in realistic development workflows—balancing developer experience, security, and deployment modes. This drove the creation of Anthar Study Verified, designed to reveal the limitations of coding agents as they engage with real-world software projects. In this blog, we walk you through the why, how, and what of Anthar, sharing insights that can shape the future of AI-assisted coding.

We conducted the **Deccan AI Anthar Study**, a comprehensive evaluation of six prominent autonomous coding agents: **Aider, SWE-agent, Cursor, OpenHands, Windsurf, and Devin**.

<figure>
  <img src="/assets/image/leaderboard.png" alt="leaderboard image">
  <figcaption><center>Fig 1.1: Leaderboard</center></figcaption>
</figure>


<figure>
  <img src="/assets/image/Whimsical.png" alt="Whimsical image">
  <figcaption><center>Fig 1.2: TL;DR</center></figcaption>
</figure>
...
2.  🙋‍♂️ **Helpfulness:** How much human effort does the agent's solution save? (Subjective, structured human judgment).
3.  📋 **Plan Creation:** How logical and sound is the agent's initial approach or plan?
4.  🛠️ **Plan Execution:** How well does the agent follow its own plan and implement the required changes?
5.  🗂️ **File Localization:** Does the agent correctly identify and modify the necessary files?
6.  🛡️ **Security Vulnerability:** Does the agent introduce security issues? (Assessed using tools like Bandit for Python and analysis against OWASP principles).
