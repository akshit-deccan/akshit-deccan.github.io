...
## Introducing the Anthar Dataset and Study Methodology

Our study is built upon the **Anthar Dataset**, a collection of 43 curated samples derived directly from resolved GitHub Pull Requests (PRs) in real-world Python (22 samples) and JavaScript (21 samples) open-source repositories.
